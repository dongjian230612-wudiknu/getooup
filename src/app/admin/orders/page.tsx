...
export default function Orders() {
  const [orders] = useState<Order[]>([
    { id: 'ORD-001', orderNumber: '#1', customer: 'John Smith', email: 'john@example.com', amount: 358.28, currency: 'USD', paymentStatus: 'captured', fulfillmentStatus: 'fulfilled', salesChannel: 'Default Sales Channel', date: '2026-03-18', items: 2, region: 'North America' },
    { id: 'ORD-002', orderNumber: '#2', customer: 'Emma Wilson', email: 'emma@example.com', amount: 62.54, currency: 'USD', paymentStatus: 'captured', fulfillmentStatus: 'fulfilled', salesChannel: 'Default Sales Channel', date: '2026-03-18', items: 1, region: 'Europe' },
    { id: 'ORD-003', orderNumber: '#3', customer: 'Michael Brown', email: 'michael@example.com', amount: 12.00, currency: 'EUR', paymentStatus: 'captured', fulfillmentStatus: 'fulfilled', salesChannel: 'Default Sales Channel', date: '2026-03-19', items: 3, region: 'Europe' },
    { id: 'ORD-004', orderNumber: '#4', customer: 'Sarah Davis', email: 'sarah@example.com', amount: 136.74, currency: 'USD', paymentStatus: 'captured', fulfillmentStatus: 'fulfilled', salesChannel: 'Default Sales Channel', date: '2026-03-20', items: 1, region: 'North America' },
    { id: 'ORD-005', orderNumber: '#5', customer: 'David Lee', email: 'david@example.com', amount: 62.54, currency: 'USD', paymentStatus: 'captured', fulfillmentStatus: 'shipped', salesChannel: 'Default Sales Channel', date: '2026-03-21', items: 2, region: 'Asia' },
    { id: 'ORD-006', orderNumber: '#6', customer: 'Lisa Chen', email: 'lisa@example.com', amount: 79.00, currency: 'CAD', paymentStatus: 'captured', fulfillmentStatus: 'shipped', salesChannel: 'Default Sales Channel', date: '2026-03-22', items: 1, region: 'North America' },
    { id: 'ORD-007', orderNumber: '#7', customer: 'James Wilson', email: 'james@example.com', amount: 115.54, currency: 'USD', paymentStatus: 'captured', fulfillmentStatus: 'shipped', salesChannel: 'Default Sales Channel', date: '2026-03-23', items: 2, region: 'North America' },
    { id: 'ORD-008', orderNumber: '#8', customer: 'Anna Zhang', email: 'anna@example.com', amount: 126.14, currency: 'USD', paymentStatus: 'captured', fulfillmentStatus: 'shipped', salesChannel: 'Default Sales Channel', date: '2026-03-24', items: 1, region: 'Asia' },
    { id: 'ORD-009', orderNumber: '#9', customer: 'Robert Taylor', email: 'robert@example.com', amount: 316.94, currency: 'USD', paymentStatus: 'captured', fulfillmentStatus: 'shipped', salesChannel: 'Default Sales Channel', date: '2026-03-25', items: 3, region: 'North America' },
    { id: 'ORD-010', orderNumber: '#10', customer: 'Maria Garcia', email: 'maria@example.com', amount: 55.00, currency: 'EUR', paymentStatus: 'captured', fulfillmentStatus: 'shipped', salesChannel: 'Default Sales Channel', date: '2026-03-26', items: 1, region: 'Europe' },
    { id: 'ORD-011', orderNumber: '#11', customer: 'Kevin Wang', email: 'kevin@example.com', amount: 94.34, currency: 'USD', paymentStatus: 'captured', fulfillmentStatus: 'shipped', salesChannel: 'Default Sales Channel', date: '2026-03-27', items: 2, region: 'Asia' },
    { id: 'ORD-012', orderNumber: '#12', customer: 'Jennifer Liu', email: 'jennifer@example.com', amount: 84.00, currency: 'EUR', paymentStatus: 'captured', fulfillmentStatus: 'delivered', salesChannel: 'Default Sales Channel', date: '2026-03-27', items: 1, region: 'Europe' },
    { id: 'ORD-013', orderNumber: '#13', customer: 'Chris Martin', email: 'chris@example.com', amount: 136.74, currency: 'USD', paymentStatus: 'captured', fulfillmentStatus: 'shipped', salesChannel: 'Default Sales Channel', date: '2026-03-28', items: 2, region: 'North America' },
    { id: 'ORD-014', orderNumber: '#14', customer: 'Amanda White', email: 'amanda@example.com', amount: 94.34, currency: 'USD', paymentStatus: 'captured', fulfillmentStatus: 'shipped', salesChannel: 'Default Sales Channel', date: '2026-03-29', items: 1, region: 'Europe' },
    { id: 'ORD-015', orderNumber: '#15', customer: 'Daniel Kim', email: 'daniel@example.com', amount: 167.48, currency: 'USD', paymentStatus: 'captured', fulfillmentStatus: 'fulfilled', salesChannel: 'Default Sales Channel', date: '2026-03-30', items: 3, region: 'Asia' },
  ]);
